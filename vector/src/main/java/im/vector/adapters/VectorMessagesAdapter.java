    ...
    private View getImageVideoView(int type, final int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            if(true){
                ...
                patientInfo.setText(RoomUtils.getBoldSpannableStringBuilder(mContext.getString(R.string.adapter_patient_info,  "PATIENT","Test", "123456789"), new ArrayList(Arrays.asList("PATIENT", "123456789"))));
