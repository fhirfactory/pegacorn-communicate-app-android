...
public class VectorOneToOneRoomCreationActivity extends MXCActionBarActivity {
    // tags
    private final String LOG_TAG = VectorOneToOneRoomCreationActivity.class.getSimpleName();
    ...
    private final ApiCallback<String> mCreateDirectMessageCallBack = new ApiCallback<String>() {
        ...
        public void onSuccess(final String roomId) {
            ...
            CommonActivityUtils.goToRoomPage(VectorOneToOneRoomCreationActivity.this, mSession, params);
        }
        ...
        private void onError(final String message) {
            membersListView.post(new Runnable() {
                ...
                public void run() {
                    if (null != message) {
                        Toast.makeText(VectorOneToOneRoomCreationActivity.this, message, Toast.LENGTH_LONG).show();
                    }
                    hideWaitingView();
                }
            });
    ...
    private void launchSearchActivity() {
        Intent intent = new Intent(VectorOneToOneRoomCreationActivity.this, VectorRoomInviteMembersActivity.class);
    ...
    private void openOrCreateDirectChatRoom(final String otherUserId) {
        doesDirectChatRoomAlreadyExist(otherUserId, new ApiCallback<String>() {
            ...
            @Override
            public void onNetworkError(Exception e) {
                ToastsKt.toast(VectorOneToOneRoomCreationActivity.this, e.getLocalizedMessage());
            }
